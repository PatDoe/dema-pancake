...
contract PancakeStrategyWithdrawMinimizeTrading is Ownable, ReentrancyGuard, IStrategy {
    ...
    /// @dev Create a new withdraw minimize trading strategy instance for pancake.
    /// @param _router The pancake router smart contract.
    constructor(IPancakeRouter02 _router, address _goblin, address _wBNB) public {
